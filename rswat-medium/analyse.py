...
rundir = '/home/pletzera/cylc-run/rswat-medium'
...
df = pd.DataFrame({'job_id': job_ids, 'exec_time': exec_times, 'mlx': mlxs})
df.to_csv('rswat-medium.csv')

print(df)

sn.barplot(data=df, x='job_id', y='exec_time', hue='mlx')
#plt.tight_layout()
plt.savefig('rswat-medium.png', bbox_inches="tight")
